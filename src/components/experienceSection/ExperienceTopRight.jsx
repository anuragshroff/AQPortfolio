    ...
    <div className="xl:w-[25%] lg:w-[30%] border border-lightBrown p-4 rounded-xl">
      <p className="text-lg text-center text-lightGrey">
        ...
        <span className="font-bold text-white">
          modern tech languages and frameworks(js, react, , php,
          laravel,css , tailwindcss etc)
        </span>
        ...
        websites to{" "}
        <span className="font-bold text-white">large-scale applications</span>.
        <span className="font-bold text-white">complex front-end & backend systems</span>,
